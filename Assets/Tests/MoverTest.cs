...
public class MoverTest
{
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(1, 0, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Speed = 1;
        mover.Direction = 0;
        //When
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(0, -1, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Speed = 1;
        mover.Direction = -90;
        //When
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(0.7f, 0.7f, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Speed = 1;
        mover.Direction = 45;
        //When
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(0.5f, 0, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Speed = 0.5f;
        //When
        yield return new WaitForSecondsRealtime(TEST_WAIT_TIME);//Testing update of Mover
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(5f, 0, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Speed = 5f;
        //When
        yield return new WaitForSecondsRealtime(TEST_WAIT_TIME);//Testing update of Mover
    ...
    {
        //Given
        Vector3 expectedPosition = GetApproximatePosition(new Vector3(0.355f,0.355f, 0) * TEST_WAIT_TIME);
        Mover mover = SpawnMoverPlayer();
        mover.Direction = 45;
        mover.Speed = 0.5f;
        //When
    ...
    Vector3 GetApproximatePosition(Vector3 position)
    {
        return new Vector3((float)Math.Round(position.x, DIGITS_POSITION_TOLERANCE), (float)Math.Round(position.y, DIGITS_POSITION_TOLERANCE), 0);
    }
}
